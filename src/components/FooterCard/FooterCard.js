          ...
          <div class="columns">
              <div class="column is-8-desktop is-offset-2-desktop">
                  ...
                  <p id="footer-credits">
                      ...
                      <br/>
                      <a rel="noopener" href="http://bulma.io" alt="Framework used on this website" target="_blank">
                          <img src={bulmaLogo} alt="Made with Bulma" width="128" height="24"/>
                      </a>
                      <br/>
                      <a rel="noopener" href="https://www.linode.com/" alt="The Host of the Website" id="linode-logo" target="_blank">
